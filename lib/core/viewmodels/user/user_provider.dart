...
import 'package:fitlife/core/models/step/step_model.dart';
...
import 'package:fitlife/core/models/weight/weight_model.dart';
...
//   }
  ...
  void storeExercise(List<ExerciseModel> exercises) async {
    try {
      await userService.storeExercise(exercises);
