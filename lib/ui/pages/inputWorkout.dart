...
import 'package:fitlife/core/models/exercise/exercise_model.dart';
...
import 'package:fitlife/core/viewmodels/exercise/exercie_provider.dart';
...
import 'package:fitlife/ui/pages/record_sport_screen.dart';
import 'package:fitlife/ui/widgets/CustomAppBar.dart';
import 'package:fitlife/ui/widgets/FoodItem.dart';
import 'package:fitlife/ui/widgets/SearchHistoryItem.dart';
...
import 'package:fitlife/ui/widgets/picker_image.dart';
import 'package:fitlife/ui/widgets/workout_item.dart';
            ...
            child: Center(
              child: Column(
                children: [
                  TextField(
                    onSubmitted: (value) {
                      ExerciseProvider.instance(context)
                          .searchLastSearch(value);
                        ...
                        children: [
                          TextField(
                            ...
                            decoration: InputDecoration(
                              ...
                              hintText: 'Cari aktivitas terakhir',
                              contentPadding: const EdgeInsets.all(18),
                            ),
                          ),
                          Container(
                  ...
                  children: [
                    TextField(
                      ...
                      decoration: InputDecoration(
                        ...
                        hintText: 'Cari aktivitas olahraga',
                        contentPadding: const EdgeInsets.all(18),
                      ),
                    ),
                    const SizedBox(height: 16),
